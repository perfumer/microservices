...
namespace Generated\Perfumer\Microservices\Notify\Request\Notifications;

class GetNotificationsRequest extends \Perfumer\Microservices\Request
{
    /**
     * @var string
     */
    ...
    {
        $this->_request_url = '/notifications';
