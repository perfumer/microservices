...
class GetComponentParametersRequest extends \Perfumer\Microservices\Request
{
    /**
     * @var int
     */
    ...
    public function __construct()
    {
        ...
        $this->component_id = new \Perfumer\Microservices\Undefined();
    ...
    {
        $array = [];
        if (!$this->component_id instanceof \Perfumer\Microservices\Undefined) {
            $array['component_id'] = $this->component_id;
        }
