...
class GetConnectorArgumentsRequest extends \Perfumer\Microservices\Request
{
    /**
     * @var int
     */
    public $connector_id = null;
    ...
    {
        $this->_request_url = '/connector/arguments';
        $this->_request_method = 'get';
        $this->connector_id = new \Perfumer\Microservices\Undefined();
    ...
    {
        $array = [];
        if (!$this->connector_id instanceof \Perfumer\Microservices\Undefined) {
            $array['connector_id'] = $this->connector_id;
        }
