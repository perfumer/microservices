...
namespace Generated\Perfumer\Microservices\Sed\Request\DocumentTickets;

class GetDocumentTicketsRequest extends \Perfumer\Microservices\Request
{
    /**
     * @var string
     */
    ...
    {
        $this->_request_url = '/document-tickets';
