...
namespace Generated\Perfumer\Microservices\Sed\Request\SignConstraints;

class GetSignConstraintsRequest extends \Perfumer\Microservices\Request
{
    /**
     * @var string
     */
    ...
    {
        $this->_request_url = '/sign-constraints';
