...
namespace Generated\Perfumer\Microservices\Posts\Request\Quizzes;

class GetQuizzesRequest extends \Perfumer\Microservices\Request
{
    /**
     * @var string
     */
    ...
    {
        $this->_request_url = '/quizzes';
        $this->_request_method = 'get';
        $this->post = new \Perfumer\Microservices\Undefined();
    ...
    {
        $array = [];
        if (!$this->post instanceof \Perfumer\Microservices\Undefined) {
