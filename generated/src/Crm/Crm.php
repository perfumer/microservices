...
abstract class Crm extends \Perfumer\Microservices\Microservice implements \Perfumer\Microservices\Contract\Crm\Crm
{
    ...
    public function emailTicket(\Perfumer\Microservices\Crm\Request\Ticket\EmailTicketRequest $request): \Perfumer\Microservices\Crm\Response\Ticket\EmailTicketResponse
    {
        /** @var \Perfumer\Microservices\Crm\Response\Ticket\EmailTicketResponse $response */
        $response = $this->doRequest($request, new \Perfumer\Microservices\Crm\Response\Ticket\EmailTicketResponse());
        $item = $this->fetchKeyFromContent($response->_content, 'ticket');
    ...
    public function createTags(\Perfumer\Microservices\Crm\Request\Tags\CreateTagsRequest $request): \Perfumer\Microservices\Crm\Response\Tags\CreateTagsResponse
    {
        /** @var \Perfumer\Microservices\Crm\Response\Tags\CreateTagsResponse $response */
        $response = $this->doRequest($request, new \Perfumer\Microservices\Crm\Response\Tags\CreateTagsResponse());
        $item = $this->fetchKeyFromContent($response->_content, 'tags');
    ...
    public function createUserTags(\Perfumer\Microservices\Crm\Request\Tags\CreateUserTagsRequest $request): \Perfumer\Microservices\Crm\Response\Tags\CreateUserTagsResponse
    {
        /** @var \Perfumer\Microservices\Crm\Response\Tags\CreateUserTagsResponse $response */
        $response = $this->doRequest($request, new \Perfumer\Microservices\Crm\Response\Tags\CreateUserTagsResponse());
        $item = $this->fetchKeyFromContent($response->_content, 'tags');
