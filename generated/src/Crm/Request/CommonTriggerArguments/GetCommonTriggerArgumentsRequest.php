...
namespace Generated\Perfumer\Microservices\Crm\Request\CommonTriggerArguments;

class GetCommonTriggerArgumentsRequest extends \Perfumer\Microservices\Request
{
    /**
     * @var int
     */
    ...
    {
        $this->_request_url = '/common-trigger/arguments';
