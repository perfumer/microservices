...
namespace Generated\Perfumer\Microservices\Crm\Request\UserModules;
...
class GetUserModulesRequest extends \Perfumer\Microservices\Request
{
    ...
    public function __construct()
    {
        ...
        $this->parent_module = new \Perfumer\Microservices\Undefined();
    ...
    public function getBody(): array
    {
        ...
        if (!$this->parent_module instanceof \Perfumer\Microservices\Undefined) {
            $array['parent_module'] = $this->parent_module;
        }
