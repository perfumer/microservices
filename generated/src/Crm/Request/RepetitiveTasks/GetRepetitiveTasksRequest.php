...
namespace Generated\Perfumer\Microservices\Crm\Request\RepetitiveTasks;

class GetRepetitiveTasksRequest extends \Perfumer\Microservices\Request
{
    /**
     * @var string
     */
    ...
    {
        $this->_request_url = '/repetitive-tasks';
