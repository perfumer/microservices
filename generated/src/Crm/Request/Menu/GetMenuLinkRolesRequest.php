...
class GetMenuLinkRolesRequest extends \Perfumer\Microservices\Request
{
    /**
     * @var int
     */
    ...
    {
        $this->_request_url = '/menu/link-roles';
        ...
        $this->menu_id = new \Perfumer\Microservices\Undefined();
    ...
    public function getBody(): array
    {
        ...
        if (!$this->menu_id instanceof \Perfumer\Microservices\Undefined) {
