...
namespace Generated\Perfumer\Microservices\Crm\Request\Startups;

class GetSvetoforStartupsRequest extends \Perfumer\Microservices\Request
{
    /**
     * @var int
     */
    ...
    {
        $this->_request_url = '/svetofor/startups';
