...
namespace Generated\Perfumer\Microservices\Crm\Request\CommonTriggers;

class GetCommonTriggersRequest extends \Perfumer\Microservices\Request
{
    /**
     * @var int
     */
    ...
    {
        $this->_request_url = '/common-triggers';
