...
namespace Generated\Perfumer\Microservices\Crm\Request\CommonScenarioTriggerArguments;

class GetCommonScenarioTriggerArgumentsRequest extends \Perfumer\Microservices\Request
{
    /**
     * @var int
     */
    ...
    {
        $this->_request_url = '/common-scenario-trigger/arguments';
        $this->_request_method = 'get';
        $this->id = new \Perfumer\Microservices\Undefined();
        $this->common_trigger_id = new \Perfumer\Microservices\Undefined();
    ...
    public function getBody(): array
    {
        ...
        if (!$this->common_trigger_id instanceof \Perfumer\Microservices\Undefined) {
            $array['common_trigger_id'] = $this->common_trigger_id;
        }
