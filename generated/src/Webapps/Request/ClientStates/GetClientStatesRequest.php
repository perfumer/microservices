...
namespace Generated\Perfumer\Microservices\Webapps\Request\ClientStates;

class GetClientStatesRequest extends \Perfumer\Microservices\Request
{
    /**
     * @var string
     */
    ...
    {
        $this->_request_url = '/clientStates';
        $this->_request_method = 'get';
        $this->bot_id = new \Perfumer\Microservices\Undefined();
    ...
    {
        $array = [];
        if (!$this->bot_id instanceof \Perfumer\Microservices\Undefined) {
            $array['bot_id'] = $this->bot_id;
        }
