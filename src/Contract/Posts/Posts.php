 ...
 *     "is_disabled", "liked_at_from", "liked_at_to", "rated_at_from", "rated_at_from", "rater_id"})
 ...
 * @SaveModel(microservice="posts", model="post", fields={"id.int"}, url="/post/increment-nb-views", action="increment")
 */
interface Posts
{
}