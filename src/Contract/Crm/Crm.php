 ...
 * @CreateModel(microservice="crm", model="ticket", fields={"user", "customer", "module", "forms_module", "forms.array", "deadline_at", "opened_at", "closed_at", "payload.array", "pub_url", "back_url", "is_hidden.bool", "tags.array", "disable_bpm.bool", "disable_box.bool", "creator_id.int"})
