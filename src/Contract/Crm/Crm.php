 ...
 * @GetModels(microservice="crm", model="customers", fields={"id.array", "group.array", "last_name", "first_name", "mid_name", "full_name", "email", "phone", "iin", "bin", "iin_bin", "type", "is_disabled.bool", "code", "created_at_from", "created_at_to", "tag", "telegram_chat_id", "telegram_username", "last_login_at.date", "locale", "profile_fields.array", "tags"})
