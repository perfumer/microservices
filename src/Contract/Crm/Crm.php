 ...
 * @SaveModel(microservice="crm", model="user", fields={"avatar", "id", "last_name", "first_name", "mid_name", "email", "phone", "iin", "code", "password", "is_admin"})
 * @UpdateModel(microservice="crm", model="user", fields={"id", "avatar", "last_name", "first_name", "mid_name", "email", "phone", "iin", "code", "password", "is_admin", "is_disabled"})
 ...
 * @GetModels(microservice="crm", model="tasks", submodel="ClosedTasksStats",  url="stats/closed-tasks", fields={"closed_at_from", "closed_at_to"}, response_fields={"stats.array"})
