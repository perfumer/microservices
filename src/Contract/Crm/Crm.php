 ...
 * @SaveModel(microservice="crm", model="customer", fields={"telegram_chat_id", "username", "avatar", "profiles.array", "last_name", "first_name", "mid_name", "email", "phone", "iin", "code", "password", "bin", "org_name", "is_nca_customer.bool", "is_disabled.bool", "groups.array", "payload.array", "auto_fields.array", "gender", "locale", "tags.array"})
 * @CreateModel(microservice="crm", model="customer", fields={"telegram_chat_id", "silent.bool", "is_protected.bool", "username", "avatar", "profiles.array", "last_name", "first_name", "mid_name", "email", "phone", "iin", "code", "password", "bin", "org_name", "is_nca_customer.bool", "is_disabled.bool", "groups.array", "payload.array", "auto_fields.array", "gender", "locale", "tags.array"})
 * @UpdateModel(microservice="crm", model="customer", fields={"telegram_chat_id", "id", "is_protected.bool", "username", "avatar", "profiles.array", "last_name", "first_name", "mid_name", "email", "phone", "iin", "code", "password", "bin", "org_name", "is_disabled.bool", "groups.array", "payload.array", "auto_fields.array", "auto_fields_merged.array", "gender", "locale", "tags.array"})
