 ...
 * @GetModels(microservice="crm", model="users", fields={"id.array", "role.array", "group.array", "last_name", "first_name", "mid_name", "full_name", "email", "phone", "iin", "bin", "org_name", "code", "telegram_chat_id", "telegram_username", "is_disabled.bool", "created_at_from", "created_at_to", "last_login_at.date", "locale", "profile_fields.array", "tags", "with_tags.bool"})
 ...
 * @CreateModel(microservice="crm", model="ticket", fields={"users.array", "customer", "module", "forms_module", "forms.array", "deadline_at", "opened_at", "closed_at", "payload.array", "pub_url", "back_url", "is_hidden.bool", "tags.array", "disable_bpm.bool", "disable_box.bool", "creator_id.int"})
 ...
 * @GetModels(microservice="crm", model="tickets", fields={"id.int","tag","is_hidden.bool","operator_user_id.int","user_id.int", "customer_id.int", "module_code", "module_id.int", "created_at_from", "created_at_to", "opened_at_from", "opened_at_to", "deadline_at_from", "deadline_at_to", "astanahub_status", "code", "business_case_id.int", "business_case_name", "process_state.int", "process_state_name", "closed_at",  "with_forms.bool", "is_closed.bool", "is_closed_successfully.bool"})
 ...
 * @UpdateModel(microservice="crm", model="task", fields={"id.int", "code", "user", "customer", "state", "activity", "group", "deadline_at", "wake_at", "complexity", "description", "link", "payload.array"})
 ...
 * @CreateModel(microservice="crm", model="task", url="task/close", action="close", fields={"task", "process_scenario", "fixes.array", "message"}, response_fields={"next_task_id"})
 ...
 * @GetModels(microservice="crm", model="customers", fields={"id.array", "group.array", "last_name", "first_name", "mid_name", "full_name", "email", "phone", "iin", "bin", "iin_bin", "type", "is_disabled.bool", "code", "created_at_from", "created_at_to", "tag", "telegram_chat_id", "telegram_username", "last_login_at.date", "locale", "profile_fields.array", "tags", "user_id.int"})
 ...
 * @CreateModel(microservice="crm", model="tags", fields={"filters", "names"})
 ...
 * @GetModels(microservice="crm", url="/svetofor/sg/consulting", model="tickets", submodel="SvetoforSgConsultingTickets", fields={"customer_id.int", "user_id.int", "tracker_id.int", "lead_tracker_id.int", "process_state_id.int", "week.int", "meeting_date_at.date"})
