 ...
 * @GetModels(microservice="crm", model="tasks", submodel="ClosedTasksStats",  url="stats/closed-tasks", fields={"user_id.int", "closed_at_from", "closed_at_to"}, response_fields={"stats.array"})
