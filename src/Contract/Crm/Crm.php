 ...
 * @CreateMeshModel(microservice="crm", model="group", fields={"id.int", "code", "name", "owner_id.int", "is_archived.bool", "profiles.array", "is_protected.bool", "payload.array"})
 * @UpdateMeshModel(microservice="crm", model="group", fields={"id.int", "name", "owner_id.int", "is_archived.bool", "profiles.array", "is_protected.bool", "payload.array"})
 ...
 * @SaveModel(microservice="crm", model="user", fields={"telegram_chat_id", "telegram_username", "username", "avatar", "id.int", "profiles.array", "last_name", "first_name", "mid_name", "email", "phone", "iin", "code", "password", "is_admin.bool", "is_disabled.bool", "payload.array", "auto_fields.array", "gender", "locale"})
 * @CreateModel(microservice="crm", model="user", fields={"telegram_chat_id", "telegram_username", "silent.bool", "is_protected.bool", "profiles.array", "username", "avatar", "last_name", "first_name", "mid_name", "email", "phone", "iin", "code", "password_hash", "password", "is_admin.bool", "is_disabled.bool", "payload.array", "auto_fields.array", "gender", "locale"})
 * @UpdateModel(microservice="crm", model="user", fields={"telegram_chat_id", "telegram_username", "is_protected.bool", "id.int", "profiles.array", "username", "avatar", "last_name", "first_name", "mid_name", "email", "phone", "iin", "code", "password_hash", "password", "is_admin.bool", "is_disabled.bool", "payload.array", "auto_fields.array", "auto_fields_merged.array", "gender", "locale"})
 ...
 * @GetModels(microservice="crm", model="users", fields={"id.array", "role.array", "group.array", "last_name", "first_name", "mid_name", "full_name", "email", "phone", "iin", "code", "telegram_chat_id", "telegram_username", "is_disabled.bool", "created_at_from", "created_at_to"})
 ...
 * @CreateModel(microservice="crm", model="ticket", fields={"user", "customer", "module", "forms_module", "forms.array", "deadline_at", "opened_at", "closed_at", "payload.array", "pub_url", "back_url", "is_hidden.bool", "tags.array", "disable_bpm.bool", "disable_box.bool"})
 ...
 * @SaveModel(microservice="crm", model="customer", fields={"telegram_chat_id", "telegram_username", "username", "avatar", "profiles.array", "last_name", "first_name", "mid_name", "email", "phone", "iin", "code", "password", "bin", "org_name", "is_nca_customer.bool", "is_disabled.bool", "groups.array", "payload.array", "auto_fields.array", "gender", "locale", "tags.array"})
 * @CreateModel(microservice="crm", model="customer", fields={"telegram_chat_id", "telegram_username", "silent.bool", "is_protected.bool", "username", "avatar", "profiles.array", "last_name", "first_name", "mid_name", "email", "phone", "iin", "code", "password", "bin", "org_name", "is_nca_customer.bool", "is_disabled.bool", "groups.array", "payload.array", "auto_fields.array", "gender", "locale", "tags.array"})
 * @UpdateModel(microservice="crm", model="customer", fields={"telegram_chat_id", "telegram_username", "id", "is_protected.bool", "username", "avatar", "profiles.array", "last_name", "first_name", "mid_name", "email", "phone", "iin", "code", "password", "bin", "org_name", "is_disabled.bool", "groups.array", "payload.array", "auto_fields.array", "auto_fields_merged.array", "gender", "locale", "tags.array"})
 ...
 * @GetModels(microservice="crm", model="customers", fields={"id.array", "group.array", "last_name", "first_name", "mid_name", "full_name", "email", "phone", "iin", "bin", "iin_bin", "type", "is_disabled.bool", "code", "created_at_from", "created_at_to", "tag", "telegram_chat_id", "telegram_username"})
 ...
 * @GetModels(microservice="crm", model="report", fields={"id.int", "filters", "formatting"}, url="/report/tickets", submodel="ReportTickets", response_fields={"tickets"})
 * @GetModels(microservice="crm", model="report", fields={"id.int", "filters", "formatting"}, url="/report/tasks", submodel="ReportTasks", response_fields={"tasks"})
