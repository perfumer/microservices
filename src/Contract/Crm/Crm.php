 ...
 * @SaveModel(microservice="crm", model="user", fields={"telegram_chat_id", "telegram_username", "username", "avatar", "id.int", "profiles.array", "last_name", "first_name", "mid_name", "email", "phone", "iin", "bin", "org_name", "code", "password", "is_admin.bool", "is_disabled.bool", "payload.array", "auto_fields.array", "gender", "locale"})
 * @CreateModel(microservice="crm", model="user", fields={"telegram_chat_id", "telegram_username", "silent.bool", "is_protected.bool", "profiles.array", "username", "avatar", "last_name", "first_name", "mid_name", "email", "phone", "iin", "bin", "org_name", "code", "password_hash", "password", "is_admin.bool", "is_disabled.bool", "payload.array", "auto_fields.array", "gender", "locale"})
 * @UpdateModel(microservice="crm", model="user", fields={"telegram_chat_id", "telegram_username", "is_protected.bool", "id.int", "profiles.array", "username", "avatar", "last_name", "first_name", "mid_name", "email", "phone", "iin", "bin", "org_name", "code", "password_hash", "password", "is_admin.bool", "is_disabled.bool", "payload.array", "auto_fields.array", "auto_fields_merged.array", "gender", "locale"})
 ...
 * @GetModels(microservice="crm", model="users", fields={"id.array", "role.array", "group.array", "last_name", "first_name", "mid_name", "full_name", "email", "phone", "iin", "bin", "org_name", "code", "telegram_chat_id", "telegram_username", "is_disabled.bool", "created_at_from", "created_at_to"})
