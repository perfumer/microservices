 ...
 * @GetModels(microservice="crm", model="users", fields={"id.array", "role.array", "group.array", "last_name", "first_name", "mid_name", "full_name", "email", "phone", "iin", "bin", "org_name", "code", "telegram_chat_id", "telegram_username", "is_disabled.bool", "created_at_from", "created_at_to", "last_login_at.date"})
 ...
 * @GetModels(microservice="crm", model="customers", fields={"id.array", "group.array", "last_name", "first_name", "mid_name", "full_name", "email", "phone", "iin", "bin", "iin_bin", "type", "is_disabled.bool", "code", "created_at_from", "created_at_to", "tag", "telegram_chat_id", "telegram_username", "last_login_at.date"})
