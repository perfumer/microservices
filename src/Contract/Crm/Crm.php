 ...
 * @SaveModel(microservice="crm", model="user", fields={"telegram_chat_id", "username", "avatar", "id.int", "profiles.array", "last_name", "first_name", "mid_name", "email", "phone", "iin", "code", "password", "is_admin.bool", "is_disabled.bool", "payload.array", "auto_fields.array", "passport_number", "id_number", "id_date_issue", "id_date_expiry", "id_issuing_authority_id.int", "id_nationality_id.int", "id_place_birth_id.int", "id_date_birth", "id_gender", "transaction_account", "bank_id.int", "region_id.int", "kato_id.int", "address", "signatory_name_official", "signatory_position", "signatory_authority", "signatory_authority_document"})
 * @CreateModel(microservice="crm", model="user", fields={"telegram_chat_id", "silent.bool", "is_protected.bool", "profiles.array", "username", "avatar", "last_name", "first_name", "mid_name", "email", "phone", "iin", "code", "password_hash", "password", "is_admin.bool", "is_disabled.bool", "payload.array", "auto_fields.array", "passport_number", "id_number", "id_date_issue", "id_date_expiry", "id_issuing_authority_id.int", "id_nationality_id.int", "id_place_birth_id.int", "id_date_birth", "id_gender", "transaction_account", "bank_id.int", "region_id.int", "kato_id.int", "address", "signatory_name_official", "signatory_position", "signatory_authority", "signatory_authority_document"})
 * @UpdateModel(microservice="crm", model="user", fields={"telegram_chat_id", "is_protected.bool", "id.int", "profiles.array", "username", "avatar", "last_name", "first_name", "mid_name", "email", "phone", "iin", "code", "password_hash", "password", "is_admin.bool", "is_disabled.bool", "payload.array", "auto_fields.array", "auto_fields_merged.array", "passport_number", "id_number", "id_date_issue", "id_date_expiry", "id_issuing_authority_id.int", "id_nationality_id.int", "id_place_birth_id.int", "id_date_birth", "id_gender", "transaction_account", "bank_id.int", "region_id.int", "kato_id.int", "address", "signatory_name_official", "signatory_position", "signatory_authority", "signatory_authority_document"})
 ...
 * @GetModels(microservice="crm", model="user", submodel="UserProfiles", fields={"modules.array", "email", "phone", "iin", "code", "username", "id.int"}, url="/user/profiles", response_fields={"profiles"})
 * @GetModel(microservice="crm", model="user", submodel="UserProfile", fields={"module", "email", "phone", "iin", "code", "username", "id.int"}, url="/user/profile", response_fields={"profile"})
 ...
 * @SaveModel(microservice="crm", model="ticket", fields={"user", "customer", "module", "code", "forms_module", "forms.array", "deadline_at", "opened_at", "closed_at", "payload.array"})
 ...
 * @SaveModel(microservice="crm", model="customer", fields={"telegram_chat_id", "username", "avatar", "profiles.array", "last_name", "first_name", "mid_name", "email", "phone", "iin", "code", "password", "bin", "org_name", "is_nca_customer.bool", "is_disabled.bool", "groups.array", "payload.array", "auto_fields.array", "passport_number", "id_number", "id_date_issue", "id_date_expiry", "id_issuing_authority_id.int", "id_nationality_id.int", "id_place_birth_id.int", "id_date_birth", "id_gender", "company_logo", "company_name_official", "company_iin_bin", "company_email", "company_telephone", "company_fax", "transaction_account", "company_transaction_account", "company_bank_id.int", "company_correspondent_account", "bank_id.int", "region_id.int", "kato_id.int", "address", "company_region_official_id.int", "company_kato_official_id.int", "company_address_official", "company_region_id.int", "company_kato_id.int", "company_address", "signatory_name_official", "signatory_position", "signatory_authority", "signatory_authority_document"})
 * @CreateModel(microservice="crm", model="customer", fields={"telegram_chat_id", "silent.bool", "is_protected.bool", "username", "avatar", "profiles.array", "last_name", "first_name", "mid_name", "email", "phone", "iin", "code", "password", "bin", "org_name", "is_nca_customer.bool", "is_disabled.bool", "groups.array", "payload.array", "auto_fields.array", "passport_number", "id_number", "id_date_issue", "id_date_expiry", "id_issuing_authority_id.int", "id_nationality_id.int", "id_place_birth_id.int", "id_date_birth", "id_gender", "company_logo", "company_name_official", "company_iin_bin", "company_email", "company_telephone", "company_fax", "transaction_account", "company_transaction_account", "company_bank_id.int", "company_correspondent_account", "bank_id.int", "region_id.int", "kato_id.int", "address", "company_region_official_id.int", "company_kato_official_id.int", "company_address_official", "company_region_id.int", "company_kato_id.int", "company_address", "signatory_name_official", "signatory_position", "signatory_authority", "signatory_authority_document"})
 * @UpdateModel(microservice="crm", model="customer", fields={"telegram_chat_id", "id", "is_protected.bool", "username", "avatar", "profiles.array", "last_name", "first_name", "mid_name", "email", "phone", "iin", "code", "password", "bin", "org_name", "is_disabled.bool", "groups.array", "payload.array", "auto_fields.array", "auto_fields_merged.array", "passport_number", "id_number", "id_date_issue", "id_date_expiry", "id_issuing_authority_id.int", "id_nationality_id.int", "id_place_birth_id.int", "id_date_birth", "id_gender", "company_logo", "company_name_official", "company_iin_bin", "company_email", "company_telephone", "company_fax", "transaction_account", "company_transaction_account", "company_bank_id.int", "company_correspondent_account", "bank_id.int", "region_id.int", "kato_id.int", "address", "company_region_official_id.int", "company_kato_official_id.int", "company_address_official", "company_region_id.int", "company_kato_id.int", "company_address", "signatory_name_official", "signatory_position", "signatory_authority", "signatory_authority_document"})
 ...
 * @GetModels(microservice="crm", model="customer", submodel="CustomerProfiles", fields={"modules.array", "email", "phone", "iin", "bin", "code", "username", "id.int"}, url="/customer/profiles", response_fields={"profiles"})
 * @GetModel(microservice="crm", model="customer", submodel="CustomerProfile", fields={"module", "email", "phone", "iin", "bin", "code", "username", "id.int"}, url="/customer/profile", response_fields={"profile"})
 *
