 ...
 *
 * @CreateModel(microservice="ncanode", model="cms", action="validate", url="/cms/validate", fields={"cms", "data", "document", "thread", "iin", "bin", "rule", "constraints.array", "verify_ocsp.bool", "verify_crl.bool"}, response_fields={"signer.array"})
