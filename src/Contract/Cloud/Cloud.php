 ...
 * @CreateModel(microservice="cloud", model="instance", fields={"first_name", "last_name", "mid_name", "email", "phone", "subdomain", "password", "iin", "bin", "org_name", "code", "silent.bool"})
 * @UpdateModel(microservice="cloud", model="instance", fields={"id.int", "first_name", "last_name", "mid_name", "email", "phone", "password", "iin", "bin", "org_name", "code"})
 * @GetModels(microservice="cloud", model="instances", fields={"id", "first_name", "last_name", "mid_name", "email", "phone", "subdomain", "iin", "bin", "org_name", "code"})
 * @CreateModel(microservice="cloud", model="instance", fields={"first_name", "last_name", "mid_name", "email", "phone", "subdomain", "password", "iin", "bin", "org_name"}, url="/instance/validate", action="validate")
