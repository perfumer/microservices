 ...
 * @SaveModel(microservice="delivery", model="delivery", fields={"min.int", "max.int", "gap.int", "has_email.bool", "has_sms.bool", "has_feed.bool", "email_subject.array", "email_html.array", "sms_message.array", "feed_title.array", "feed_text.array", "feed_image.array", "feed_payload.array", "data_url", "filters.array"})
 * @UpdateModel(microservice="delivery", model="delivery", fields={"id.int", "min.int", "max.int", "gap.int", "has_email.bool", "has_sms.bool", "has_feed.bool", "email_subject.array", "email_html.array", "sms_message.array", "feed_title.array", "feed_text.array", "feed_image.array", "feed_payload.array"})
