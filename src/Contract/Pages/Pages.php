 ...
 * @SaveModel(microservice="pages", model="component", fields={"id.int", "name", "description", "module", "type", "old_module", "old_type", "is_sub.bool", "parameters.array", "categories.array"})
 */
interface Pages
{
