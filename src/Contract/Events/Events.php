 ...
 * @SaveMeshModel(microservice="events", model="module", fields={"code", "name", "description", "is_archived.bool"})
 * @SaveMeshModel(microservice="events", model="module", fields={"id", "code", "name", "description", "is_archived.bool"}, action="update", request_method="patch")
