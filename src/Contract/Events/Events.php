 ...
 * @CreateModel(microservice="events", model="module", fields={"name", "customer_name", "description", "customers_ticket_crm_module", "user_ticket_crm_module", "tickets_mode", "allowed_crm_modules", "allowed_crm_module_mode", "allowed_crm_ticket_from", "is_archived.bool", "weekly_schedule_limit.int", "is_scheduled.bool", "tags"})
 * @UpdateModel(microservice="events", model="module", fields={"name", "customer_name", "description", "customers_ticket_crm_module", "user_ticket_crm_module", "tickets_mode", "allowed_crm_modules", "allowed_crm_module_mode", "allowed_crm_ticket_from", "is_archived.bool", "weekly_schedule_limit.int", "is_scheduled.bool", "tags"})
