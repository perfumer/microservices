 ...
 * @SaveModel(microservice="forms", model="field", fields={"label.array", "hint.array", "type", "model", "module", "reference", "is_required.bool", "is_dedicated.bool", "is_invisible_for_applicant.bool", "dedicated_column_index", "priority.int", "bind_field", "bind_field_mode", "aggregation_tag", "aggregation_mode"})
