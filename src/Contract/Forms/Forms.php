 ...
 * @CreateModel(microservice="forms", model="form", fields={"code", "silent.bool", "ticket_id.int", "user_id.int", "customer_id.int", "module", "fields.array", "payload.array"})
 * @UpdateModel(microservice="forms", model="form", fields={"id.int","code","ticket_id.int", "user_id.int", "customer_id.int", "module", "fields.array", "payload.array"})
 * @UpsertModel(microservice="forms", model="form", fields={"code","ticket_id.int", "user_id.int", "customer_id.int", "module", "fields.array", "payload.array"})
 * @SaveModel(microservice="forms", model="form", fields={"ticket_id.int", "user_id.int", "customer_id.int", "module", "fields.array", "payload.array"})
